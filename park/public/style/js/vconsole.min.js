...
!(function(e, t) {
    ...
    return (function(e) {
                                    ...
                                    (o = [
                                        ...
                                        },
                                        {
                                            ...
                                            value: function(e, t) {
                                                if (
                                                    "function" ==
                                                    typeof this.eventList[e]
                                                )
                                                    this.eventList[e].call(
                                                        this,
                                                        t
                                                    );
                                                else {
        ...
        function(e, t, o) {
            var n, r, i;
            (r = [t, o(0), o(1), o(2), o(18), o(19), o(20)]),
                void 0 ===
                    (i =
                        "function" ==
                ...
                for (var o = 0; o < e.length; o++) {
                    ...
                    if (i) {
                        ...
                        for (; a < n.parts.length; a++)
                            i.parts.push(b(n.parts[a], t));
                    } else {
                        for (var l = []; a < n.parts.length; a++)
                            l.push(b(n.parts[a], t));
                ...
                void 0 ===
                    (i =
                        ...
                        typeof (n = function(
                                            ...
                                            },
                                            {
                                                ...
                                                value: function() {
                                                    if (this.isInited) {
                                                        ...
                                                        this.$dom.parentNode.removeChild(
                                                            this.$dom
                                                        ),
                                                            (this.isInited = !1);
                                                    }
                            ...
                            (x.VConsolePlugin = v.default),
                                (x.VConsoleLogPlugin = f.default),
                                (x.VConsoleDefaultPlugin = p.default),
                                (x.VConsoleSystemPlugin = b.default),
                                (x.VConsoleNetworkPlugin = g.default),
                                (x.VConsoleElementPlugin = h.default),
                                (x.VConsoleStoragePlugin = m.default);
                            var k = x;
                            ...
                            _createClass(VConsoleDefaultTab, [
                                {
                                    ...
                                    value: function onReady() {
                                        ...
                                        for (var i = 0; i < winKeys.length; i++)
                                            keyTypes[winKeys[i]] = _typeof(
                                                window[winKeys[i]]
                                            );
                                        var cacheObj = {},
                                            ID_REGEX = /[a-zA-Z_0-9\$\-\u00A2-\uFFFF]/,
                                            retrievePrecedingIdentifier = function(
                                                e,
                                                t,
                                                o
                                            ) {
                                        ...
                                        _query.default.bind(
                                            ...
                                            function(e) {
                                                var isDeleteKeyCode =
                                                        8 === e.keyCode ||
                                                        46 === e.keyCode,
                                                    $prompted = _query.default.one(
                                                        ".vc-cmd-prompted"
                                                    );
                                                ($prompted.style.display =
                                                    "none"),
                                                    ($prompted.innerHTML = "");
                                                ...
                                                if (value && value.length > 0) {
                                                    ...
                                                    if ("." === value) {
                                                        ...
                                                        for (
                                                            ...
                                                            if (
                                                                ...
                                                                var _$li = document.createElement(
                                                                    "li"
                                                                );
                                                                (_$li.innerHTML =
                                                                    winKeys[
                                                        ...
                                                        if (cacheObj[arr[0]]) {
                                                            ...
                                                            for (
                                                                ...
                                                                var _$li2 = document.createElement(
                                                                        "li"
                                                                    ),
                                                                    _key3 =
                                                                        cacheObj[
                                                    ...
                                                    if (
                                                        ...
                                                        ($prompted.style.display =
                                                            "block"),
                                                            ($prompted.style.height =
                                                                m + "px"),
                                                            ($prompted.style.marginTop =
                                                                -m + "px");
                                                    }
                                                } else
                                                    $prompted.style.display =
                                        ...
                                        (code += "if (!!window) {"),
                                            (code +=
                                                "window.__vConsole_cmd_result = undefined;"),
                                            (code +=
                                                "window.__vConsole_cmd_error = false;"),
                                            (code += "}");
                                        var scriptList = document.getElementsByTagName(
                                                "script"
                                            ),
                                            nonce = "";
                                        scriptList.length > 0 &&
                                    ...
                                    value: function(e) {
                                        ...
                                        tool.isArray(o) || tool.isObject(o)
                                            ...
                                            : (tool.isNull(o)
                                                  ...
                                                  : tool.isString(o) &&
                                                    (o = '"' + o + '"'),
                                              (t = _query.default.render(
                                                  _item_code.default,
                                                  { content: o, type: "output" }
                                              ))),
                                            this.printLog({
                                                logType: "log",
                                                content: t,
        ...
        function(e, t, o) {
            var n, r, i;
            (r = [t, o(1), o(0), o(2), o(27), o(28), o(29)]),
                void 0 ===
                    (i =
                        "function" ==
                        typeof (n = function(o, n, r, i, a, l, c) {
        ...
        function(e, t, o) {
            var n, r, i;
            (r = [t, o(31), o(2), o(33), o(34), o(0), o(1)]),
                void 0 ===
                    (i =
                        "function" ==
                        typeof (n = function(o, n, r, i, a, l, c) {
                            ...
                            var b = (function(e) {
                                function t() {
                                    ...
                                    return (
                                        (u.observer = new p(function(e) {
                                            for (var t = 0; t < e.length; t++) {
                                                var o = e[t];
                                                u._isInVConsole(o.target) ||
                                                    u.onMutation(o);
                                            }
                                        })),
                                        o
